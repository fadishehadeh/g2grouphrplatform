...
<div class="row g-4 mb-4">
    <div class="col-md-3"><a href="<?= e(url('/employees')); ?>" class="card dashboard-card text-decoration-none"><div class="card-body"><span>System Users</span><h3><?= e((string) $stats['headcount']); ?></h3></div></a></div>
...
<div class="card border-0 shadow-sm"><div class="card-body"><h5>Platform Control Center</h5><p class="text-muted mb-0">This dashboard will aggregate cross-company statistics, settings, user controls, and audit insights.</p></div></div>