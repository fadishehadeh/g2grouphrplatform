        ...
        <div class="col-xl-8">
            <div class="card content-card mb-4"><div class="card-body p-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4"><label class="form-label">Nationality</label><input type="text" name="nationality" class="form-control" value="<?= e((string) old('nationality', $employee['nationality'] ?? '')); ?>"></div>
                </div>
            </div></div>
