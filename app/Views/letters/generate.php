...
<div class="row g-4">
    ...
    <div class="col-xl-4">
        <?php if ($isAdmin && $statusVal === 'pending'): ?>
        <!-- Generate Form -->
        <div class="card content-card mb-4">
            <div class="card-body p-4">
                <h6 class="mb-3">Generate Letter</h6>
                <form method="post" action="<?= e(url('/letters/' . (int) $letter['id'] . '/generate')); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="additional_info" id="additional_info" class="form-control form-control-sm" rows="3"
                                  placeholder="Any extra paragraph to include in the letter..."></textarea>
                    </div>
                    <div class="d-grid">
                        <button type="submit" class="btn btn-primary btn-sm">
                            <i class="bi bi-file-earmark-check"></i> Generate &amp; Approve
                        </button>
                    </div>
                </form>
                <hr>
        ...
        <div class="card content-card mb-4">
            <div class="card-body p-4">
                <div class="d-grid gap-2">
                    <a href="<?= e(url('/letters/' . (int) $letter['id'] . '/view')); ?>" class="btn btn-success">
