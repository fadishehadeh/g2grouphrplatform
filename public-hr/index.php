...
$_SERVER['APP_URL']   = 'https://hr.greydoha.com';
putenv('APP_URL=https://hr.greydoha.com');

$_ENV['SESSION_NAME']    = 'hr_system_session';
$_SERVER['SESSION_NAME'] = 'hr_system_session';
putenv('SESSION_NAME=hr_system_session');
